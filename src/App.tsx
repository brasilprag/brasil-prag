...
export const MAP = `https://www.google.com/maps?q=${encodeURIComponent(ENDERECO)}&output=embed`;
...
function FloatingIcons({ whatsappLink }: { whatsappLink: string }) {
  return (
    <div className="floatingIcons" aria-label="Ações rápidas (fixo)">
      <a
        className="iconGlass"
        href={whatsappLink}
        target="_blank"
...
export default function App() {
  ...
  return (
    <>
      {/* Ícones verticais fixos na direita */}
      <FloatingIcons whatsappLink={wa(homeMsg)} />

      <Routes>
        <Route path="/" element={<Home />} />

        {/* Rotas de páginas SEO */}
        <Route path="/:slug" element={<CityRoute />} />
